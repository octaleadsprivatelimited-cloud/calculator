...
export default function AreaConverter() {
  ...
  return (
    <div className="min-h-screen bg-google-bg py-8">
      <div className="w-full px-4">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="bg-google-bg p-3 rounded-2xl shadow-google">
              <Globe className="w-8 h-8 text-white" />
            </div>
          </div>
          <h1 className="text-4xl font-bold text-google-text mb-2">Area Converter</h1>
          <p className="text-lg text-google-gray">Convert between different area units and measurements</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="google-card overflow-hidden p-6">
              <div className="flex items-center gap-3 mb-6">
                <Calculator className="w-6 h-6 text-google-blue" />
                <h2 className="text-2xl font-bold text-google-text">Area Conversion</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none text-lg"
                      step="any"
                      min="0"
                    />
                                         <select
                       ...
                       className="px-4 py-3 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none bg-white"
                ...
                <div className="flex justify-center">
                  ...
                  >
                    <svg className="w-5 h-5 text-google-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-3xl bg-gray-50 text-lg font-mono"
                    />
                                         <select
                       value={toUnit}
                ...
                {/* Result Display */}
                {result !== null && (
                  <div className="bg-google-blueLight border border-blue-200 rounded-3xl p-4">
                    <div className="text-center">
                      <p className="text-sm text-google-blue mb-1">Conversion Result</p>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {quickExamples.map((example, index) => (
                  <button
                    ...
                    className="w-full text-left p-3 bg-gray-50 hover:bg-gray-100 rounded-2xl transition-colors duration-200"
                  >
            ...
            {/* Common Conversions */}
            <div className="google-card overflow-hidden p-6">
              <h3 className="text-lg font-semibold text-google-text mb-4">Common Conversions</h3>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-google-blue text-white rounded-3xl hover:bg-google-blueHover transition-colors duration-200 font-medium"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-gray-600 text-white rounded-3xl hover:bg-gray-700 transition-colors duration-200 font-medium"
          >
      ...
      <div className="mt-8 p-6 google-result-card">
        <h3 className="text-xl font-semibold text-google-text mb-4">About Area Converter</h3>
        <div className="prose prose-gray max-w-none">
          ...
          <h4 className="text-lg font-semibold text-google-text mb-2">Supported Area Units</h4>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div>
              <h5 className="font-semibold text-google-text mb-2">Construction & Building</h5>
              <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
          ...
          <h4 className="text-lg font-semibold text-google-text mb-2">Unit Selection Guidelines</h4>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
