    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={homePrice} onChange={(e) => setHomePrice(e.target.value)} className="google-input" placeholder="Enter price" step="1000" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Down Payment (%)</label>
              <select value={downPaymentPercent} onChange={(e) => setDownPaymentPercent(e.target.value)} className="google-input" aria-label="Select down payment percentage">
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Down Payment Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Down Payment Options</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Low Down Payment</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">High Down Payment</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Down Payment Fundamentals</h4>
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">PMI Requirements</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">PMI Required (Below 20%)</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">No PMI (20% or Higher)</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Loan Type Considerations</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Down Payment Sources</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Personal Savings</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Alternative Sources</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Down Payment Strategies</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Down Payment Calculation Tips</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Common Down Payment Mistakes</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Advanced Down Payment Concepts</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
