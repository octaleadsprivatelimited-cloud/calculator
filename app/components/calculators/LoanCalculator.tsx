    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Loan Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Types of Loans Supported</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Personal Loans</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Secured Loans</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                  <li>Auto loans</li>
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Loan Optimization Tips</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
