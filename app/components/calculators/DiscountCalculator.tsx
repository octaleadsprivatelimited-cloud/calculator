    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Discount Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Percentage Discount</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Fixed Amount Discount</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Discount Fundamentals</h4>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Retail Shopping</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Business Applications</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Discount Calculation Methods</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Smart Shopping Strategies</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Price Comparison</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Discount Optimization</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Discount Calculation Tips</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Common Discount Mistakes</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Advanced Discount Concepts</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
