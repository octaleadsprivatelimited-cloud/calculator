    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={initialInvestment} onChange={(e) => setInitialInvestment(e.target.value)} className="google-input" placeholder="Enter investment" step="1000" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Annual Cash Flow ()</label>
              <input type="number" value={annualCashFlow} onChange={(e) => setAnnualCashFlow(e.target.value)} className="google-input" placeholder="Enter cash flow" step="100" />
            </div>
          </div>
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Payback Period Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Understanding Payback Period</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">What is Payback Period?</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Payback Period Categories</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Payback Period vs. Other Metrics</h4>
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Factors Affecting Payback Period</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Best Practices</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
