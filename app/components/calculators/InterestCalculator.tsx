    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={principal} onChange={(e) => setPrincipal(e.target.value)} className="google-input" placeholder="Enter amount" step="100" />
            </div>
            <div>
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Interest Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Simple vs. Compound Interest</h4>
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Interest Rate Considerations</h4>
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Factors Affecting Interest Growth</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
