    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center py-8">
          ...
          <h1 className="text-4xl font-bold text-google-text mb-2">SIP Calculator</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Input Form */}
          <div className="google-card overflow-hidden border border-gray-100 p-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg"
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-google hover:shadow-google transform hover:-translate-y-1"
              >
            ...
            {results ? (
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-3xl p-4">
                  <h3 className="text-lg font-semibold text-google-text mb-3">Key Insights</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-google-gray">Return on Investment:</span>
                      <span className="font-semibold text-green-600">
                        {((results.totalReturns / results.totalInvestment) * 100).toFixed(1)}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-google-gray">Monthly Investment:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-google-gray">Expected Return:</span>
        ...
        {results && (
          <div className="mt-8 google-card overflow-hidden border border-gray-100 p-6">
            <h2 className="text-2xl font-bold text-google-text mb-6">Yearly Breakdown</h2>
                ...
                <tbody>
                  {results.breakdown.map((row) => (
                    <tr key={row.year} className="border-b border-gray-100 hover:bg-gray-50">
                      <td className="py-3 px-4 font-medium text-google-text">{row.year}</td>
                      ...
                      <td className="py-3 px-4 text-right font-semibold text-google-text">{formatCurrency(row.total)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
          <h3 className="text-xl font-bold text-google-text mb-4">About SIP Calculator</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-700">
            <div>
              <h4 className="font-semibold text-google-text mb-2">What is SIP?</h4>
              <p className="mb-3">
              ...
              <h4 className="font-semibold text-google-text mb-2">Key Benefits:</h4>
            ...
            <div>
              <h4 className="font-semibold text-google-text mb-2">How to Use:</h4>
              ...
              <h4 className="font-semibold text-google-text mb-2">Important Notes:</h4>
