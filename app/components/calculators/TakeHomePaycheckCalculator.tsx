      ...
      <div className="p-6">
        <div className="space-y-4">
          <div>
            ...
            <input type="number" value={grossPay} onChange={(e) => setGrossPay(e.target.value)} className="google-input" placeholder="Enter gross pay" step="0.01" />
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Federal Tax</label>
              <input type="number" value={federalTax} onChange={(e) => setFederalTax(e.target.value)} className="google-input" placeholder="Enter federal tax" step="0.01" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">State Tax</label>
              <input type="number" value={stateTax} onChange={(e) => setStateTax(e.target.value)} className="google-input" placeholder="Enter state tax" step="0.01" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="number" value={socialSecurity} onChange={(e) => setSocialSecurity(e.target.value)} className="google-input" placeholder="Enter SS tax" step="0.01" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Medicare</label>
              <input type="number" value={medicare} onChange={(e) => setMedicare(e.target.value)} className="google-input" placeholder="Enter Medicare" step="0.01" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Other</label>
              <input type="number" value={otherDeductions} onChange={(e) => setOtherDeductions(e.target.value)} className="google-input" placeholder="Enter other" step="0.01" />
            </div>
          </div>
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Take-Home Paycheck Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Common Deductions Explained</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Federal Taxes</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">State & Local Taxes</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Factors Affecting Take-Home Pay</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Pre-Tax vs. Post-Tax Deductions</h4>
