    ...
    <div className="w-full google-card overflow-hidden">
      ...
      <div className="p-6">
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={carPrice} onChange={(e) => setCarPrice(e.target.value)} className="google-input" placeholder="Enter price" step="1000" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Down Payment ()</label>
              <input type="number" value={downPayment} onChange={(e) => setDownPayment(e.target.value)} className="google-input" placeholder="Enter down payment" step="500" />
            </div>
          </div>
        ...
        <div className="mt-8 p-6 google-result-card">
          <h3 className="text-xl font-semibold text-google-text mb-4">About Auto Loan Calculator</h3>
          <div className="prose prose-gray max-w-none">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Auto Loan Components</h4>
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div>
                <h5 className="font-semibold text-google-text mb-2">Vehicle Costs</h5>
              ...
              <div>
                <h5 className="font-semibold text-google-text mb-2">Loan Terms</h5>
                <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Auto Loan Optimization Tips</h4>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-1">
            ...
            <h4 className="text-lg font-semibold text-google-text mb-2">Common Auto Loan Terms</h4>
