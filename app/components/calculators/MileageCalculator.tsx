          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-lg border border-blue-200">
              <ResultSharing
                ...
                inputs={[
                  { label: "Calculation Type", value: calculationType === 'trip' ? 'Trip Planning' : 'Fuel Efficiency' },
                  { label: "Distance", value: `${tripData.distance} miles` },
                  { label: "Fuel Efficiency", value: `${tripData.fuelEfficiency} MPG` }
                ]}
                result={{ 
                  label: "Total Cost", 
