...
export const metadata: Metadata = {
  ...
  category: 'Technology', classification: 'Calculator Tools',
  other: {
    'msapplication-TileColor': '#3B82F6', 'msapplication-config': '/browserconfig.xml',
    'theme-color': '#3B82F6', 'apple-mobile-web-app-capable': 'yes',
    'apple-mobile-web-app-status-bar-style': 'default', 'apple-mobile-web-app-title': 'Calculator.net',
    'application-name': 'Calculator.net', 'mobile-web-app-capable': 'yes',
  },
